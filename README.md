...
- 8. Calculate the average turnaround time: Average TAT = (Sum of all TAT) / n
...
- 4. Save the file with the extension .c (e.g., fcfs.c).
...
- 9. Verify that the processes are executed in the order of their arrival (FCFS principle).
